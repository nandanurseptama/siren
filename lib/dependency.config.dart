...
import 'package:siren/dependency.dart' as _i29;
...
import 'package:siren/features/user/presentation/friends_cubit.dart' as _i28;
import 'package:siren/features/user/presentation/profile_cubit.dart' as _i26;
import 'package:siren/features/user/presentation/users_cubit.dart' as _i27;
...
Future<_i1.GetIt> $InitDependency(
  ...
  gh.lazySingleton<_i16.DislikePostUsecase>(() => _i16.DislikePostUsecase(
        uuidGenerator: gh<_i12.UUIDGenerator>(),
        logger: gh<_i7.Logger>(),
        postRepository: gh<_i10.PostRepository>(),
      ));
  gh.lazySingleton<_i17.GetFriendsUsecase>(() => _i17.GetFriendsUsecase(
        uuidGenerator: gh<_i12.UUIDGenerator>(),
        logger: gh<_i7.Logger>(),
        userRepository: gh<_i13.UserRepository>(),
      ));
  gh.lazySingleton<_i18.GetLikedPostsUsecase>(() => _i18.GetLikedPostsUsecase(
        uuidGenerator: gh<_i12.UUIDGenerator>(),
        logger: gh<_i7.Logger>(),
        postRepository: gh<_i10.PostRepository>(),
      ));
  gh.lazySingleton<_i19.GetPostsUsecase>(() => _i19.GetPostsUsecase(
        uuidGenerator: gh<_i12.UUIDGenerator>(),
        logger: gh<_i7.Logger>(),
        postRepository: gh<_i10.PostRepository>(),
      ));
  gh.lazySingleton<_i20.GetUserProfileByIdUsecase>(
      () => _i20.GetUserProfileByIdUsecase(
            uuidGenerator: gh<_i12.UUIDGenerator>(),
            logger: gh<_i7.Logger>(),
            userRepository: gh<_i13.UserRepository>(),
          ));
  gh.lazySingleton<_i21.GetUsersUsecase>(() => _i21.GetUsersUsecase(
        uuidGenerator: gh<_i12.UUIDGenerator>(),
        logger: gh<_i7.Logger>(),
        userRepository: gh<_i13.UserRepository>(),
      ));
  gh.lazySingleton<_i22.IsFriendUsecase>(() => _i22.IsFriendUsecase(
        uuidGenerator: gh<_i12.UUIDGenerator>(),
        logger: gh<_i7.Logger>(),
        userRepository: gh<_i13.UserRepository>(),
      ));
  gh.lazySingleton<_i23.LikePostUsecase>(() => _i23.LikePostUsecase(
        uuidGenerator: gh<_i12.UUIDGenerator>(),
        logger: gh<_i7.Logger>(),
        postRepository: gh<_i10.PostRepository>(),
      ));
  gh.lazySingleton<_i24.LikedPostsCubit>(() => _i24.LikedPostsCubit(
        getLikedPostsUsecase: gh<_i18.GetLikedPostsUsecase>(),
        dislikePostUsecase: gh<_i16.DislikePostUsecase>(),
        likePostUsecase: gh<_i23.LikePostUsecase>(),
      ));
  gh.lazySingleton<_i25.PostsCubit>(
      () => _i25.PostsCubit(getPostsUsecase: gh<_i19.GetPostsUsecase>()));
  gh.factory<_i26.ProfileCubit>(
    () => commonModule.meStateManager(
      env: gh<_i6.Env>(),
      getUserProfileByIdUsecase: gh<_i20.GetUserProfileByIdUsecase>(),
    ),
    instanceName: 'profileMeCubit',
  );
  gh.lazySingleton<_i27.UsersCubit>(
      () => _i27.UsersCubit(getUsersUsecase: gh<_i21.GetUsersUsecase>()));
  gh.lazySingleton<_i28.FriendsCubit>(
      () => _i28.FriendsCubit(getFriendsUsecase: gh<_i17.GetFriendsUsecase>()));
  return getIt;
}

class _$CommonModule extends _i29.CommonModule {}
